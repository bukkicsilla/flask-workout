...
db.session.add(e3)
db.session.commit()
v31 = Video(videoid="", title="Pilates 1", rating=7, exercise_name="Pilates")
v32 = Video(videoid="", title="Pilates 2", rating=8, exercise_name="Pilates")
v33 = Video(videoid="", title="Pilates 3", rating=6, exercise_name="Pilates")
v34 = Video(videoid="", title="Pilates 4", rating=10, exercise_name="Pilates")
v35 = Video(videoid="", title="Pilates 5", exercise_name="Pilates")
v36 = Video(videoid="", title="Pilates 6", exercise_name="Pilates")
v37 = Video(videoid="", title="Pilates 7", exercise_name="Pilates")
v38 = Video(videoid="", title="Pilates 8", exercise_name="Pilates")
db.session.add(v31)
db.session.add(v32)
db.session.add(v33)
db.session.add(v34)
